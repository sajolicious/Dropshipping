...
const CartScreen = () => {
  ...
  return (
    <Row>
      <Col md={8}>
        <h1 style={{ marginBottom: '20px' }}>Shopping Bag</h1>
      ...
      <Card >
        <ListGroup variant='flush'>
          ...
          <ListGroup.Item>
            <Button type='button' className='btn-block' disabled={cartItems.length ===0 } onClick={checkoutHandler}>Processed to checkout</Button>
          </ListGroup.Item>
        </ListGroup>
      </Card>
      </Col>
